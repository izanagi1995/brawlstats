...
class NotFoundError(RequestError):
    ...
    def __init__(self, code, **kwargs):
        ...
        super().__init__(code, 'An incorrect tag has been passed.')
...
class UnexpectedError(RequestError):
    ...
    def __init__(self, url, code, text):
        self.url = url
        super().__init__(self.code, 'An unexpected error has occured.\n{text}')
...
class ServerError(RequestError):
    ...
    def __init__(self, code, url):
        self.url = url
        super().__init__(code, 'The API is down. Please be patient and try again later.')
